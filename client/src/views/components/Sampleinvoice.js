    ...
    <div>
      <div>
        ...
        <div id="page-wrap">
          ...
          <div id="identity">
            <textarea id="address">
              Chris Coyier 123 Appleseed Street Appleville, WI 53719 Phone:
              (555) 555-5555
            </textarea>
            ...
            <div id="logo">
              <div id="logoctr">
                ...
                <a href="javascript:;" id="save-logo" title="Save changes">
                  Save
                </a>
                |
          ...
          <table id="items">
            ...
            <tr class="item-row">
              ...
              <td class="description">
                <textarea>
                  Monthly web updates for http://widgetcorp.com (Nov. 1 - Nov.
                  30, 2009)
                </textarea>
              </td>
              <td>
            ...
            <tr class="item-row">
              ...
              <td class="description">
                <textarea>
                  Yearly renewals of SSL certificates on main domain and several
                  subdomains
                </textarea>
              </td>
              <td>
                <textarea class="cost">$75.00</textarea>
              </td>
              <td>
                <textarea class="qty">3</textarea>
              </td>
              <td>
